...
export default function FrescoBelloSection() {
  return (
    <section className="relative min-h-[35rem] border-b-4 flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        ...
        <div className='flex items-center justify-center'>
          <Button to="/about" variant="light" size="lg" className='border border-gold text-white bg-gold hover:text-obsidian'>
          About Us
        </Button>
        </div>
      </motion.div>
